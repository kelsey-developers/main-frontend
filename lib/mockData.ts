...
export const unitListings: Record<string, Listing> = {
  ...
  '4': {
    id: '4',
    title: 'Seaside Cottage in La Union',
    ...
    square_feet: 900,
    property_type: 'House',
    description: 'Charming seaside cottage with ocean breeze and a short walk to the beach. Great for weekend surf trips and family stays.',
    main_image_url: '/heroimage.png',
    image_urls: ['/heroimage.png', '/heroimage.png'],
    amenities: ['Beach Access', 'WiFi', 'Kitchen', 'Parking', 'Outdoor Shower'],
    is_featured: false,
    is_available: true,
    latitude: 16.6154,
    longitude: 120.3176,
  ...
  '5': {
    id: '5',
    title: 'Garden Villa in Antipolo',
    ...
    square_feet: 2200,
    property_type: 'Villa',
    description: 'Private villa surrounded by lush gardens with spacious living areas and outdoor seating. Ideal for family gatherings.',
    main_image_url: '/heroimage.png',
    image_urls: ['/heroimage.png', '/heroimage.png', '/heroimage.png'],
    amenities: ['Garden', 'WiFi', 'Air Conditioning', 'Parking', 'Kitchen'],
    is_featured: false,
    is_available: true,
    latitude: 14.5995,
    longitude: 121.1756,
  ...
  '6': {
    id: '6',
    title: 'Urban Studio in Quezon City',
    ...
    square_feet: 450,
    property_type: 'Condo',
    description: 'Compact studio near business hubs with modern finishes and fast WiFi. Perfect for solo travelers.',
    main_image_url: '/heroimage.png',
    image_urls: ['/heroimage.png'],
    amenities: ['WiFi', 'Air Conditioning', 'Security', 'Elevator'],
    is_featured: false,
    is_available: true,
    latitude: 14.6760,
    longitude: 121.0437,
  ...
  '7': {
    ...
    square_feet: 2400,
    property_type: 'Condo',
    description: 'Luxury penthouse with skyline views, premium furnishings, and top-tier amenities.',
    main_image_url: '/heroimage.png',
    image_urls: ['/heroimage.png', '/heroimage.png'],
    amenities: ['WiFi', 'Pool', 'Gym', 'Concierge', 'Smart Home'],
    is_featured: true,
    is_available: true,
    latitude: 14.5515,
    longitude: 121.0466,
  ...
  '8': {
    ...
    square_feet: 3000,
    property_type: 'House',
    description: 'Spacious family home with a large backyard and modern kitchen. Close to schools and shopping.',
    main_image_url: '/heroimage.png',
    image_urls: ['/heroimage.png', '/heroimage.png', '/heroimage.png'],
    amenities: ['WiFi', 'Air Conditioning', 'Garden', 'Parking', 'Laundry'],
    is_featured: false,
    is_available: true,
    latitude: 14.4189,
    longitude: 121.0380,
