...
const SharingTools: React.FC<SharingToolsProps> = ({ slug, isAgentView }) => {
          ...
          <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 items-center sm:items-start">
            ...
            <div className="flex-1 w-full">
              ...
              <p
                ...
                style={{ fontFamily: 'Poppins', fontWeight: 400 }}
              >
                Share this link on Facebook, Messenger, or WhatsApp to attract clients directly to your profile.
              </p>
