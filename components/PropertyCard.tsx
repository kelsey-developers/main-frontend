  ...
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-6">
        <div className="mb-4">
          <div className="flex items-baseline justify-between">
            <div>
              ...
              <span
                className="text-gray-500 text-xs sm:text-sm ml-1 sm:ml-2"
            ...
            {apartment.is_featured && (
              <span
                className="inline-flex px-2 py-1 rounded-full text-xs font-medium text-[#0B5858] bg-[#0B5858]/10"
                style={{ fontFamily: 'Poppins' }}
              >
                Featured
              </span>
        ...
        <h3
          className="text-base sm:text-lg font-semibold text-black mb-2 line-clamp-2"
